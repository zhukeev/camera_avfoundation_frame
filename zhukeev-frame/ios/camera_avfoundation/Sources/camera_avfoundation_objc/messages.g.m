...
void SetUpFCPCameraApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger,
  ...
  /// Returns the list of available cameras.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.flutter.pigeon.camera_avfoundation_frame_frame_frame_frame_frame_frame_frame_frame."
  ...
  /// Create a new camera with the given settings, and returns its ID.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:
                                      @"%@%@",
                                      @"dev.flutter.pigeon.camera_avfoundation_frame_frame_frame_frame_frame_frame_frame_frame.CameraApi.create",
                                      messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FCPGetMessagesCodec()];
    if (api) {
  ...
  /// Initializes the camera with the given ID.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:
               [NSString
                   stringWithFormat:@"%@%@",
                                    @"dev.flutter.pigeon.camera_avfoundation_frame_frame_frame_frame_frame_frame_frame_frame.CameraApi.initialize",
                                    messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FCPGetMessagesCodec()];
    if (api) {
  ...
  /// Stops streaming frames from the camera.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString
                            stringWithFormat:
                                @"%@%@",
                                @"dev.flutter.pigeon.camera_avfoundation_frame_frame_frame_frame_frame_frame_frame_frame.CameraApi.stopImageStream",
                                messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FCPGetMessagesCodec()];
    if (api) {
  ...
  /// and any associated resources can be cleaned up.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:
                                      @"%@%@",
                                      @"dev.flutter.pigeon.camera_avfoundation_frame_frame_frame_frame_frame_frame_frame_frame.CameraApi.dispose",
                                      messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FCPGetMessagesCodec()];
    if (api) {
  ...
  /// resulting file.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:
               [NSString
                   stringWithFormat:@"%@%@",
                                    @"dev.flutter.pigeon.camera_avfoundation_frame_frame_frame_frame_frame_frame_frame_frame.CameraApi.takePicture",
                                    messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FCPGetMessagesCodec()];
    if (api) {
  ...
  /// Switches the camera to the given flash mode.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString
                            stringWithFormat:
                                @"%@%@",
                                @"dev.flutter.pigeon.camera_avfoundation_frame_frame_frame_frame_frame_frame_frame_frame.CameraApi.setFlashMode",
                                messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FCPGetMessagesCodec()];
    if (api) {
  ...
  /// Switches the camera to the given exposure mode.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString
                            stringWithFormat:
                                @"%@%@",
                                @"dev.flutter.pigeon.camera_avfoundation_frame_frame_frame_frame_frame_frame_frame_frame.CameraApi.setExposureMode",
                                messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FCPGetMessagesCodec()];
    if (api) {
  ...
  /// Switches the camera to the given focus mode.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString
                            stringWithFormat:
                                @"%@%@",
                                @"dev.flutter.pigeon.camera_avfoundation_frame_frame_frame_frame_frame_frame_frame_frame.CameraApi.setFocusMode",
                                messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FCPGetMessagesCodec()];
    if (api) {
  ...
  /// A null value resets to the default focus point.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString
                            stringWithFormat:
                                @"%@%@",
                                @"dev.flutter.pigeon.camera_avfoundation_frame_frame_frame_frame_frame_frame_frame_frame.CameraApi.setFocusPoint",
                                messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FCPGetMessagesCodec()];
    if (api) {
  ...
  /// Returns the minimum zoom level supported by the camera.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString
                            stringWithFormat:
                                @"%@%@",
                                @"dev.flutter.pigeon.camera_avfoundation_frame_frame_frame_frame_frame_frame_frame_frame.CameraApi.getMinZoomLevel",
                                messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FCPGetMessagesCodec()];
    if (api) {
  ...
  /// Returns the maximum zoom level supported by the camera.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString
                            stringWithFormat:
                                @"%@%@",
                                @"dev.flutter.pigeon.camera_avfoundation_frame_frame_frame_frame_frame_frame_frame_frame.CameraApi.getMaxZoomLevel",
                                messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FCPGetMessagesCodec()];
    if (api) {
  ...
  /// Sets the zoom factor.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString
                            stringWithFormat:
                                @"%@%@",
                                @"dev.flutter.pigeon.camera_avfoundation_frame_frame_frame_frame_frame_frame_frame_frame.CameraApi.setZoomLevel",
                                messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FCPGetMessagesCodec()];
    if (api) {
  ...
  /// Pauses streaming of preview frames.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString
                            stringWithFormat:
                                @"%@%@",
                                @"dev.flutter.pigeon.camera_avfoundation_frame_frame_frame_frame_frame_frame_frame_frame.CameraApi.pausePreview",
                                messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FCPGetMessagesCodec()];
    if (api) {
  ...
  /// Resumes a previously paused preview stream.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString
                            stringWithFormat:
                                @"%@%@",
                                @"dev.flutter.pigeon.camera_avfoundation_frame_frame_frame_frame_frame_frame_frame_frame.CameraApi.resumePreview",
                                messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FCPGetMessagesCodec()];
    if (api) {
...
- (void)deviceOrientationChangedOrientation:(FCPPlatformDeviceOrientation)arg_orientation
  ...
  NSString *channelName = [NSString
      stringWithFormat:
          @"%@%@",
          @"dev.flutter.pigeon.camera_avfoundation_frame_frame_frame_frame_frame_frame_frame_frame.CameraGlobalEventApi.deviceOrientationChanged",
...
- (void)initializedWithState:(FCPPlatformCameraState *)arg_initialState
  ...
  NSString *channelName = [NSString
      stringWithFormat:@"%@%@",
                       @"dev.flutter.pigeon.camera_avfoundation_frame_frame_frame_frame_frame_frame_frame_frame.CameraEventApi.initialized",
                       _messageChannelSuffix];
  FlutterBasicMessageChannel *channel =
      [FlutterBasicMessageChannel messageChannelWithName:channelName
                                         binaryMessenger:self.binaryMessenger
...
- (void)reportError:(NSString *)arg_message
         completion:(void (^)(FlutterError *_Nullable))completion {
  NSString *channelName = [NSString
      stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camera_avfoundation_frame_frame_frame_frame_frame_frame_frame_frame.CameraEventApi.error",
                       _messageChannelSuffix];
  FlutterBasicMessageChannel *channel =
      [FlutterBasicMessageChannel messageChannelWithName:channelName
                                         binaryMessenger:self.binaryMessenger
